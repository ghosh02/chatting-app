...
function Profile() {
  ...
  return (
    <div className=" pt-20">
      ...
      {isModalOpen && (
        <div
          // className="fixed  inset-0 bg-base-300  flex items-center justify-center z-50 transition duration-1000 ease-in-out"
          className={`fixed inset-0 bg-base-300 bg flex items-center justify-center z-50 transition-opacity duration-1000 ${
